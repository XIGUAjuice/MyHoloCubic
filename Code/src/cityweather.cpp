...
void createPageWeather()
{
  ...
  lv_label_set_text(label_temp_city1, "0℃");
  ...
  lv_obj_set_style_local_text_font(label_text_city1, 0, 0, &temp_font);
  lv_label_set_text(label_text_city1, "广州");
  ...
  lv_label_set_text(label_temp_city2, "0℃");
  // lv_label_set_align(label_temp, LV_LABEL_ALIGN_CENTER);
  ...
  lv_label_set_text(label_text_city2, "北京");
  lv_obj_set_style_local_text_font(label_text_city2, 0, 0, &temp_font);
  ...
  lv_label_set_text(label_temp_city3, "0℃");
  // lv_label_set_align(label_temp, LV_LABEL_ALIGN_CENTER);
  ...
  lv_label_set_text(label_text_city3, "杭州");
  lv_obj_set_style_local_text_font(label_text_city3, 0, 0, &temp_font);
